...
public class Aplicacao {
    ...
    public void menuPrincipal() throws InterruptedException{
        ...
        while (aplicacaoAtiva) {
            ...
            while (escolha < 1 || escolha > 8) {
                ...
                System.out.println("|      [4] Agendar Aluguel              |");
                System.out.println("|      [5] Obter Valor de Referência    |");
                System.out.println("|      [6] Disponibilidade de Imóvel    |");
                System.out.println("|      [7] Consultar Aluguel            |");
    ...
    public void agendarBloqueio() {
        ...
        boolean resultado;
        try {
           resultado =  this.si.bloquearImovel(numeroIPTU, dataBloqueio);
        } catch (NaoExistemException e) {
            System.out.println("\n========================================================");
    ...
    public void agendarAluguel() {
        ...
        System.out.print(" [-] Digite a data de aluguel (no formato dd/mm/yyyy): ");
        String dataBloqueio = in.nextLine();


        boolean resultado;
        try {
            resultado = this.si.alugarImovel(numeroIPTU, dataBloqueio);
        } catch (NaoExistemException e) {
            System.out.println("\n========================================================");
            System.out.println("  Não existem imóveis cadastrados no momento.");
            System.out.println("========================================================");
        ...
        if (resultado) {
            System.out.println("\n==================================================");
            System.out.println("    IMÓVEL ("+ numeroIPTU +") ALUGADO NA DATA: " + dataBloqueio);
            System.out.println("--------------------------------------------------");
        }
    }
