...
public abstract class Imovel implements Aluguel {
    ...
    public boolean adicionarDataAlugadaAgenda(String data) {
        return this.agenda.adicionarDataAlugada(data);
    }

    public boolean adicionarDataBloqueadaAgenda(String data) {
        return this.agenda.adicionarDataBloqueada(data);
    }
    ...
    public double calcularPrecoAluguel(String dataInicio, String dataFim) {
        ...
        try {
            ...
            double resultado = this.calcularValorReferencia() * diferencaDias+1;
            if (resultado > 0)  {
                return resultado;
            } else {
                return 0.0;
